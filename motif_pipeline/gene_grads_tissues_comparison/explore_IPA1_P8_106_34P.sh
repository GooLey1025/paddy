...
MODEL=P8_106tracks_34P

GFF=$PREFIX/motif_pipeline/Rice_MSUv7.gff3
MODEL_PATH=$PREFIX/seq2exp/best_model_dirs/${MODEL}_TrunkFrozen_PaddyHead_best_model_dir/seed100_model_best.h5
...
paddy_grad_gene.py --model_path $MODEL_PATH --fa $FA --rc \
    --atg -o $GENE_ID.$MODEL.h5 $YAML $GENE_ID.gff3

# explore_IPA1.ipynb as a template
cp explore_IPA1.ipynb explore_$GENE_ID.$MODEL.ipynb
